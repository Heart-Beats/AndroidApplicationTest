...
import com.example.zhanglei.myapplication.util.flyme.StatusbarColorUtils
import com.example.zhanglei.myapplication.util.flyme.StatusbarColorUtils.*
...
object StatusBarUtil {
    ...
    fun statusBarLightMode(window: Window): Int {
        return when {
            miuiSetStatusBarLightMode(window, true) -> 1
            flymeSetStatusBarLightMode(window, true) -> 2
    ...
    fun statusBarDarkMode(window: Window): Int {
        return when {
            miuiSetStatusBarLightMode(window, false) -> 1
            flymeSetStatusBarLightMode(window, false) -> 2
            Build.VERSION.SDK_INT >= Build.VERSION_CODES.M -> {
                window.decorView.systemUiVisibility = View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN or View.SYSTEM_UI_FLAG_LAYOUT_STABLE
                3
            }
